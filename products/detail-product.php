            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="slider-zoom">
                        <a href="<?php echo IMGURLPRODUCTS; ?>/<?php echo $product->image; ?>" class="cloud-zoom"
                            ...
                            <img alt="Detail Zoom thumbs image"
                                src="<?php echo IMGURLPRODUCTS; ?>/<?php echo $product->image; ?>" style="width: 100%;">
                        </a>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <form method="POST" id="form-data">
                        <div class="row">
                            <div class="col-sm-5">
                                <input class="form-control" name="pro_title" type="hidden"
                                    value="<?php echo $product->Title; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-5">
                                <input class="form-control" name="pro_image" type="hidden"
                                    value="<?php echo $product->image; ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-5">
                                <input class="pro_price form-control" name="pro_price" type="hidden"
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <input class="form-control" name="pro_id" type="hidden"
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <input class="pro_qty form-control" type="number" min="1"
                                    ...
                                    data-bts-button-up-class="btn btn-primary" name="pro_qty"
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <input class="subtotal_price form-control" name="pro_subtotal" type="hidden"
                                    value="<?php echo $product->price * $product->quantity; ?>">
                            </div>
                        </div>
                        ...
                        <?php endif; ?>
                        <?php else : ?>
                        <div class="mt-5 alert alert-success bg-success text-white text-center" role="alert">
                            <p class="mb-0">Login to buy this product</p>
                        </div>
                        <?php endif; ?>
                    </form>
                </div>
                        ...
                        <div class="item">
                            <div class="card card-product">
                                ...
                                <div class="card-badge">
                                    ...
                                    <img src="<?php echo IMGURLPRODUCTS; ?>/<?php echo $RelatedProduct->image;?>"
                                        alt="Card image 2" class="card-img-top">
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a href="detail-product.php"><?php echo $RelatedProduct->Title;?></a>
                                    </h4>
                                    <div class="card-price">
                                        <!-- <span class="discount">Rp. 300.000</span> -->
                                        <span class="reguler">$<?php echo $RelatedProduct->price;?></span>
                                    </div>
                                    <a href="<?php echo APPURL;?>/products/detail-product.php?id=<?php echo $RelatedProduct->id;?>"
...
$(document).ready(function() {
    ...
    //Remake the quantity as one. if it's zero...
    ...
    $(".btn-insert").on("click", function(e) {
        ...
        $.ajax({
            url: "<?php echo APPURL;?>/products/detail-product.php?id=<?php echo $id; ?>",
            method: "POST",
            data: form_data,
            ...
            success: function() {
                ...
                $(".btn-insert").html(
                    " <i class='fa fa-shopping-basket'></i> Added to Cart").prop(
                    "disabled", true);
                withRef();
            }
