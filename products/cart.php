                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="<?php echo IMGURLPRODUCTS; ?>/<?php echo  $product->pro_image; ?>"
                                            width="60">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button value="<?php echo  $product->id; ?>" class="btn-update btn btn-primary">
                                            UPDATE</button>
                                    </td>
                                ...
                                <div class="alert alert-success bg-success text-white text-center" role="alert">
                                    ...
                                    <p class="mb-0">There are no items in the cart yet</p>
                                </div>
                                <?php endif; ?>
                            </tbody>
                        </table>
