<?php
    session_start();
    define("APPURL" , "http://localhost/FreshKit");
    define("IMGURLCATEGORY","http://localhost/FreshKit/admin-panel/categories-admins/img-category");
    define("IMGURLPRODUCTS","http://localhost/Freshkit/admin-panel/products-admins/img-products");

    require ("C:/xampp/htdocs/FreshKit/config/config.php");
...
<head>
    <title>FreshKit | Groceries Organic Store</title>
    <meta charset="utf-8">
