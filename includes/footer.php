<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <h5>About</h5>
                <p>FreshKit is an innovative e-commerce platform dedicated to connecting you with a wide range of
                    restaurants and food vendors in your area.</p>
            </div>
            <div class="col-md-3">
                <h5>Links</h5>
                <ul>
            ...
            <div class="col-md-3">
                ...
                <ul>
                    <li>
                        <a href="tel:+620892738334"><i class="fa fa-phone"></i> 07123456789</a>
                    </li>
                    <li>
                        <a href="mailto:hello@domain.com"><i class="fa fa-envelope"></i> FreshKit@domain.com</a>
                    </li>
                </ul>
            ...
            <div class="col-md-3">
                ...
                <ul class="mb-0">
                    ...
                    <li style="height: 200px">
                        <div class="mockup">
                            <img src="<?php echo APPURL;?>/assets/img/mockup-1.png">
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <p class="copyright">&copy; 2024 FreshKit | Groceries Organic Store. All rights reserved.</p>
</footer>
...
<script type="text/javascript" src="<?php echo APPURL;?>/assets/packages/bootstrap-touchspin/bootstrap-touchspin.js">
</script>
